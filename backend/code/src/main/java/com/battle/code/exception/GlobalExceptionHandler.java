...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleAuthenticationRequired(AuthenticationCredentialsNotFoundException exception) {
        return response(HttpStatus.UNAUTHORIZED, "UNAUTHORIZED", "Authentication required");
    }
